class OrgPeopleController < ApplicationController
    ...
    def update
        ...
        #Using the org_person_id find/create the record and assong the attributes to @contactInfo
        ...
        #Find contacts record or create the if necessary
        ...
        if @contact.update_attributes(@org_ca)
            # If this user also controls the information of company (i.e COO) then also update company email
